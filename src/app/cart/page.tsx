...
export default function CartPage() {
  ...
  const shipping =
    lines.length > 0 && currentSubtotal < freeShippingThreshold
      ? flatRate
      : 0;
    ...
    return (
      <div className="container-vl py-32 text-center">
        ...
        <p className="text-obsidian/60 mt-3">
          Discover the collection and start your ritual.
        </p>
      ...
      <div className="grid lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 space-y-8">
          {lines.map((l) => (
            <div
              key={l.productId}
              className="flex gap-5 border-b border-obsidian/10 pb-8"
            >
              ...
              <div className="flex-1 flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() =>
                      removeItem(l.productId)
                    }
                    className="flex items-center gap-1 text-xs text-obsidian/50 hover:text-error"
                  >
                    <Trash2 size={13} />
                    Remove
                  </button>
        ...
        <div className="bg-blush/60 p-8 h-fit">
          ...
          <Link
            href="/shop"
            className="block text-center text-xs tracking-widest uppercase mt-4 text-obsidian/60 hover:text-obsidian"
          >
            Continue Shopping
          </Link>
        </div>
